; Bootloader
; Memory organisation (as described by The Linux/x86 boot protocol):
; 0x07c00 - 0x07dff Bootloader + partition table + MBR magic number
; 0x10000 - 0x17fff Real mode kernel
; 0x18000 - 0x1dfff Stack and Heap 
; 0x1e000 - 0x1ffff Kernel Command Line
; 0x20000 - 0x2fdff Temporary location for protected mode kernel 

; Heap End Pointer = Heap End - 0x200 = 0xde00	
